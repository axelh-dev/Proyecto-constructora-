...
from .views import MunicipalidadViewSet, ProjectsViewSet, PhotosViewSet, VideosViewSet, cargar_archivo, UserRoleViewSet, ProyectMuni, videosProyect
from . import views
#api versioning 
...
urlpatterns = [
    ...
    path('proyectosf/<int:projecto_id>/', views.videosProyect, name='Filtro_video'),
